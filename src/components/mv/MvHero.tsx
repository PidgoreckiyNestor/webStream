...
function heroIndex(i: number): CSSProperties {
  return { ["--mv-i" as string]: i };
}
    ...
    <section id="home" className="relative flex flex-col justify-start pt-24 pb-8 lg:min-h-[100svh] lg:pt-20 lg:pb-10">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl pt-4 text-center">
          ...
          <div data-mv-hero style={heroIndex(2)}>
            <ProofLine className="mt-5 justify-center" />
          </div>
          <div data-mv-hero style={heroIndex(3)} className="mt-8">
            <PlatformBadges />
          </div>
        </div>
        <div data-mv-hero style={heroIndex(4)} className="mt-10">
          <NameMarquee />
        </div>
        <div
          data-mv-lcp
          className="relative mx-auto mt-10 w-full max-w-5xl flex-1 lg:mt-14"
        >
          <div className="absolute -inset-10 -z-10 hidden rounded-3xl bg-primary/12 blur-3xl lg:block" />
          <ProductCarousel />
        </div>
        <div data-mv-hero style={heroIndex(5)} className="mt-8 flex justify-center pb-2 lg:mt-10">
          <InPageAnchor
            targetId="pricing"
